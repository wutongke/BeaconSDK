...
//	private static final int EmptyValue = 1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		uuidTextView.setOnClickListener(new OnClickListener() {
			LinearLayout ll = (LinearLayout)getLayoutInflater().inflate(R.layout.attr_modify_dialog,null);
			final EditText attrValue = (EditText)ll.findViewById(R.id.attr_value);
			@Override
				...
				.setPositiveButton("保存", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						if(!attrValue.getText().toString().equals("")){
							beaconConnection.setUUID(attrValue.getText().toString());
						} else{
			...
			public void onClick(View v) {
				...
				.setPositiveButton("保存", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						if(!attrValue.getText().toString().equals("")){
							try{
								beaconConnection.setCalRssi(Integer.valueOf(attrValue.getText().toString()) );
							}catch (Exception e){
								handler.sendEmptyMessage(EMPTYVALUE);
							}
						} else{
	...
	protected void onDestroy() {
		// TODO Auto-generated method stub
		super.onDestroy();
		if (beaconConnection.isConnection()) {
