...
public class ScannerServiceParser {
	 ...
	 * </p>
	 */
	protected static boolean decodeDeviceAdvData(byte[] data, UUID requiredUUID) {
	 ...
	 * parse it manually :(
	 */
	protected static String decodeDeviceName(byte[] data) {
		String name = null;
		int fieldLength, fieldName;
		int packetLength = data.length;
		for (int index = 0; index < packetLength; index++) {
	 ...
	 */
	protected static String decodeLocalName(final byte[] data, final int start,
			final int length) {
		try {
